...
#define KP_TIMEOUT_DEFAULT_MS 50 ///////was 2000
...
// EEPROM DEFINES
//
// PUTTING INDIVIDUAL ENTRIES ON THIER OWN 32BYTE PAGE
#define EPROM_PAGE_SZ 32
#define SECOND_PAGE_OFFSET 1
#define EPROM_DELAY() pause(5)

//IN THE FIRST EEPROM PAGE
//#define EEPROM_SIG1 0
//#define EEPROM_SIG2 1
#define ARM_DELAY_OFFSET 2
#define ENTRY_DELAY_OFFSET 3
#define DARK_THRESHOLD_OFFSET 4
//SECOND PAGE
#define SECOND_PAGE_OFFSET 1
#define ASI_OFFSET (SECOND_PAGE_OFFSET * EPROM_PAGE_SZ)
#define SENSOR_PACKET_SIZE 9
#define MS_OFFSET (ASI_OFFSET+(NUM_OF_SYSTEMS * EPROM_PAGE_SZ))
#define X_MOTION_PACKET_SIZE 7
#define OUTPUT_OFFSET (MS_OFFSET+(X_MOTION_DETECTORS * EPROM_PAGE_SZ))
#define OUTPUT_PACKET_SIZE 3
#define AUTO_LIS_OFFSET (OUTPUT_OFFSET+(NUM_OF_AUTO_O * EPROM_PAGE_SZ))
#define AUTO_LIS_PACKET_SIZE 4
#define USERDATA_OFFSET (AUTO_LIS_OFFSET+(NUM_OF_AUTO_LIS * EPROM_PAGE_SZ))
#define USERDATA_PACKET_SIZE 14
#define AUTO_X_OFFSET (USERDATA_OFFSET+(MAX_USERS * EPROM_PAGE_SZ))
#define AUTO_X_PACKET_SIZE 3
//#define BOOTTIME_OFFSET (AUTO_X_OFFSET+(NUM_OF_X_FLASHES * EPROM_PAGE_SZ))
