...
struct ALARM_SYSTEM_S motion_lights[] = {
		{ "MTN_S", 1, 20, A_S_INACTIVE, NONE, NONE, A_S_SIG_LEVEL_HIGH, X_LIGHT_ON_TIME, 0, L_X_S },
		{ "MTN_N", 1, 22, A_S_INACTIVE, NONE, NONE, A_S_SIG_LEVEL_HIGH, X_LIGHT_ON_TIME, 0, L_X_N },
		{ "MTN_E", 1, 23, A_S_INACTIVE, NONE, NONE, A_S_SIG_LEVEL_HIGH, X_LIGHT_ON_TIME, 0, L_X_E },
		{ "MTN_W", 1, 26, A_S_INACTIVE, NONE, NONE, A_S_SIG_LEVEL_HIGH, X_LIGHT_ON_TIME, 0, L_X_W },
};


struct ALARM_SYSTEM_S automation_O[] =
{
		{ "L_X_S", 2, 3, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY, A_S_SIG_LEVEL_LOW, NONE },
		{ "L_X_N", 0, 18, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY, A_S_SIG_LEVEL_LOW, NONE },
		{ "L_X_E", 2, 4, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY, A_S_SIG_LEVEL_LOW, NONE },
