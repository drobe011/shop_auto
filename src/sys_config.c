...
{
		{ "INDCT", 0, 17, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_HIGH, NONE },
		{ "L_X_N", 0, 18, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_LOW, NONE },
		{ "L_I_M", 0, 24, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_LOW, NONE },
		{ "L_X_S", 2, 3, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_LOW, NONE },
		{ "L_X_E", 2, 4, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_LOW, NONE },
		{ "L_X_W", 2, 5, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_HIGH, NONE },
		{ "FAN", 2, 6, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY, A_S_SIG_LEVEL_HIGH,
				NONE },
		{ "L_I_S", 3, 25, A_S_INACTIVE, A_S_NOT_REQ_TO_ARM, A_S_ARM_ST_AWAY,
				A_S_SIG_LEVEL_HIGH, NONE }, };
